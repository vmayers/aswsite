  ...
  def create
    ...
    respond_to do |format|
      if @executive_position.save
        format.html { redirect_to(@executive_position, :notice => 'Executive position was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @executive_position.update_attributes(params[:executive_position])
        format.html { redirect_to(@executive_position, :notice => 'Executive position was successfully updated.') }
        format.xml  { head :ok }
      else
